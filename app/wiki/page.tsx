...
import { articles, wikiCategories, getArticlesByCategory, searchArticles } from './data/articles';
        ...
        <div className='max-w-7xl mx-auto p-6'>
          ...
          <div className='bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-6 mb-8'>
            ...
            <div className='flex gap-4 text-sm'>
              <span className='text-[#f5c518]'>📚 {articles.length} Articles</span>
          ...
          <div className='mt-8 bg-[#252525] border border-[#3a3a3a] rounded-lg p-6'>
            ...
            <p className='text-gray-300 text-sm'>
              To add new articles, edit the file at <code className='bg-[#1a1a1a] px-2 py-1 rounded text-[#8ab4f8]'>app/wiki/data/articles.ts</code>. 
              Each article will automatically get its own shareable URL at <code className='bg-[#1a1a1a] px-2 py-1 rounded text-[#8ab4f8]'>/wiki/[slug]</code>.
            </p>
          </div>
        </div>
      )}
